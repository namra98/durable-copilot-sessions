...
.DESCRIPTION
  Shows a tray icon with quick actions (Open dashboard, Snapshot now, Restore
...
[void]$menu.Items.Add("Open dashboard", $null, { Invoke-Dcs "serve --port $Port"; Start-Process "http://127.0.0.1:$Port" })
...
$icon.add_MouseDoubleClick({ Start-Process "http://127.0.0.1:$Port" })
